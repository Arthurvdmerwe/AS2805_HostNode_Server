...
from Data_Structures.ISO8583_Structs.ISOErrors import *
...
"""
    ...
    _BITS_VALUE_TYPE = {1: ['BME', 'Bit Map Extended', 'B', 16, 'b'],
                        ...
                        13: ['13', 'Date effective', 'N', 4, 'n'],
                        14: ['14', 'Date expiration', 'N', 4, 'n'],
                        15: ['15', 'Date settlement', 'N', 4, 'n'],
                        16: ['16', 'Date conversion', 'N', 4, 'n'],
                        17: ['17', 'Date capture', 'N', 4, 'n'],
                        18: ['18', 'Message error indicator', 'LLL', 4, 'n'],
                        ...
                        22: ['22', 'Point of service data code', 'N', 4, 'n'],
                        ...
                        32: ['32', 'Acquiring institution identification code', 'LL', 12, 'n'],
                        33: ['33', 'Forwarding institution identification code', 'LL', 12, 'n'],
                        34: ['34', 'Electronic commerce data', 'LL', 28, 'n'],
                        35: ['35', 'Track 2 data', 'LL', 37, 'n'],
                        36: ['36', 'Track 3 data', 'LLL', 104, 'n'],
                        ...
                        88: ['88', 'Debits, amount', 'N', 15, 'n'],
                        89: ['89', 'Debits, reversal amount', 'N', 15, 'n'],
                        90: ['90', 'Original data elements', 'N', 42, 'n'],
                        91: ['91', 'File update code', 'AN', 1, 'an'],
                        92: ['92', 'File security code', 'N', 2, 'n'],
                        93: ['93', 'Response indicator', 'N', 5, 'n'],
                        94: ['94', 'Service indicator', 'AN', 7, 'an'],
                        95: ['95', 'Replacement amounts', 'AN', 42, 'an'],
                        96: ['96', 'Message security code', 'AN', 8, 'an'],
                        97: ['97', 'Amount, net settlement', 'N', 16, 'n'],
                        98: ['98', 'Payee', 'ANS', 25, 'ans'],
                        ...
                        126: ['126', 'Issuer trace id', 'LL', 6, 'ans'], 127: ['127', 'ICC Data', 'LLL', 999, 'ans'],
    ...
    def showBitsFromBitmapStr(self, bitmap):
        ...
        """
        bits = self.__inicializeBitsFromBitmapStr()
    ...
    def __inicializeBitsFromBitmapStr(self):
    ...
    def getBitsAndValues(self):
        ...
        for cont in range(2, 129):
            if self.BITMAP_VALUES[cont] != self._BIT_DEFAULT_VALUE:
                _TMP = {'bit': "%d" % cont, 'type': self.getBitType(cont), 'value': self.BITMAP_VALUES[cont]}
                ret.append(_TMP)
        return ret
