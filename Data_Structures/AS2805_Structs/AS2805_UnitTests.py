...
class Default_0820TestCasePack(AS2805_0820_TestCases):
    ...
    def runTest(self):
        ...
        self.assertEqual(net_iso[2:].encode('hex'), self.Switch_Request, 'Message is not a Match')
...
class Default_0820TestCaseUnPack(AS2805_0820_TestCases):
    ...
    def runTest(self):
        ...
        iso_resp.setNetworkISO(HexToByte(self.Host_Request))
        host_iso = iso_resp.getNetworkISO()

        self.assertEqual(host_iso[2:].encode('hex'), self.Host_Request, 'Message is not a Match')
...
class Default_0830UnTestCasePack(AS2805_0820_TestCases):
    def runTest(self):
        ...
        self.assertEqual(net_iso[2:].encode('hex'), self.Switch_Response, 'Message is not a Match')
...
class Default_0830UnTestCaseUnPack(AS2805_0820_TestCases):
    def runTest(self):
        ...
        iso_resp = AS2805(debug=False)
        iso_resp.setNetworkISO(HexToByte(self.Host_Response))
        host_iso = iso_resp.getNetworkISO()

        self.assertEqual(host_iso[2:].encode('hex'), self.Host_Response, 'Message is not a Match')
...
class Default_0810UTestCaseUnPack(AS2805_0800_TestCases):
    def runTest(self):
        ...
        print "Switch 0810 Test"
        iso_resp = AS2805(debug=False)
        iso_resp.setNetworkISO(HexToByte(self.Switch_Response))
        host_iso = iso_resp.getNetworkISO()

        self.assertEqual(host_iso[2:].encode('hex'), self.Switch_Response, 'Message is not a Match')
...
class Default_0800TestCasePack(AS2805_0800_TestCases):
    def runTest(self):
        ...
        host_iso = iso_resp.getNetworkISO()
        self.assertEqual(host_iso[2:].encode('hex'), self.Switch_Request, 'Message is not a Match')
