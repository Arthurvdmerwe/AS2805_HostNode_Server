...
class AS2805:
    ...
    _DEF[36] = ['36', 'Track 3 Data',                          'LL',   104, 'z',   'c',    'F',   'left']
    ...
    _DEF[48] = ['48', 'Additional Data Private',              'LLL', 999, 'ans',    'x',    'F',   'left']
    ...
    _DEF[70] = ['70', 'Network Management Information Code',    'F',      4, 'n',       'n',    '0',  'right']
    ...
    def setNetworkISO(self, iso, bigEndian=True):
        ...
        self.setIsoContent(ByteToHex(iso))
...
if __name__ == '__main__':
   ...
   # iso.setBit(128, '027980E700000000')
    ...
    #print "Binary Data: \n"
    #print hexdump.hexdump(iso.getNetworkISO())
