...
#Exception used to indicate that the value that setting in the bit has invalid length
class InvalidValueLen(Exception):
    """	Exeption that indicate that a value that want to set inside the bit is has invalid length
...
#Exception that indicate a invalid header, maybe it is not set
class InvalidHeader(Exception):
    """Exception that indicate a invalid header
    """
